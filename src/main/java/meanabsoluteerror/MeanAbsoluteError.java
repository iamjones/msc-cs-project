        ...
        try {
            ...
            while (results.length != 0) {
                ...
                for (Document d : results) {
                    ...
                    difference += Math.abs(d.get_source().getUserRating() - d.get_source().getPredictedRating());
                    numOfRecords++;
                }
            }

            Double mae = difference / numOfRecords;
            ...
            System.out.println("-----------");
            System.out.println("-----------");
            System.out.println("Mean Absolute Error is: ");
